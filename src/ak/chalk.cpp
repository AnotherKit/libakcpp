...
std::string replaceClose (size_t index, const std::string &str, const std::string &close, const std::string &replace) {
...
std::string filterEmpty (const std::string &open, const std::string &close, const std::string &str, const std::string &replace) {
...
std::string filterEmpty (const std::string &open, const std::string &close, const std::string &str) {
